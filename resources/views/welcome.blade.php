                ...
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th id="th-konsumsi" class="px-6 py-4 text-right font-bold text-[#1E3A5F] uppercase tracking-wider">Konsumsi</th>
                            <th id="th-neraca" class="px-6 py-4 text-right font-bold text-[#1E3A5F] uppercase tracking-wider">Neraca / Selisih</th>
    ...
    <script>
        ...
        function renderAll() {
            ...
            if (currentMode === 'tahunan') {
                ...
                if (thKonsumsi) thKonsumsi.innerText = "Konsumsi (Juta Ton)";
